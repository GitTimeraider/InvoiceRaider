<script lang="ts">
  let { settings, t, canUpdateSettings } = $props<{
    settings: any;
    t: any;
...
<div class="space-y-4">
  ...
  <label class="form-control">
    ...
    <textarea class="textarea textarea-bordered h-24 w-full" bind:value={settings.companyAddress} disabled={!canUpdateSettings}></textarea>
  </label>
